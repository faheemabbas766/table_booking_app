    ...
    while (true) {
      ...
      if (value) {
        if (Provider.of<SearchPro>(context, listen: false).areas.isNotEmpty) {
          Provider.of<SearchPro>(context, listen: false)
              .areas
              .insert(0, AreaObject(0, "All"));
                        ...
                        children: [
                            ...
                            onPressed: () async {
                              var d = await showDatePicker(
                                ...
                                firstDate: DateTime.now()
                                    .subtract(const Duration(days: 9999999)),
                          ...
                          Row(
                            children: [
                              ...
                              DropdownButton<AreaObject>(
                                ...
                                value: Provider.of<SearchPro>(context)
                                    .selectedarea,
                                items: Provider.of<SearchPro>(context)
                                    .areas
                                    .map((AreaObject area) {
                          ...
                          ElevatedButton(
                            ...
                            onPressed: Provider.of<SearchPro>(context).d == null
                                ? null
                                : () {
                                    if (Provider.of<SearchPro>(context,
                                                listen: false)
                                            .selectedarea ==
                                        null) {
                            ...
                            child: Text(
                              "Search",
                              style:
                                  TextStyle(fontSize: RouteManager.width / 21),
                            ),
                          ),
                                                                ...
                                                                ElevatedButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    custpersons
                                                                        ...
                                                                        .ttlpersons
                                                                        .toString();
                                                                    bookedfor = Provider.of<SearchPro>(
                                                                            context,
                                                                            listen:
                                                                                false)
                                                                        .searches[
                                                                                    ...
                                                                                    TextButton(
                                                                                      ...
                                                                                      onPressed: () async {
                                                                                        ...
                                                                                        if (d != null) {
                                                                                          ...
                                                                                          print("STATE SETTEDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDdd$bookedfor");
                                                                                        }
                                                                                      },
                                                                                    ),
                                                                                    ElevatedButton(
                                                              ...
                                                              children: [
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                        (context) {
                                                                      String hour = Provider.of<SearchPro>(
                                                                              context)
                                                                          .searches[
                                                                              index]
                                                                          .bookedfor
                                                                          .hour
                                                                          .toString();
                                                                      String minute = Provider.of<SearchPro>(
                                                                              context)
                                                                          .searches[
                                                                              index]
                                                                          .bookedfor
                                                              ...
                                                              children: [
                                                                ...
                                                                Builder(
                                                                  builder:
                                                                    ...
                                                                    return Text(
                                                                      Provider.of<SearchPro>(context).searches[index].checkin ==
                                                                              null
                                                                          ? "Not Checked In"
                                                                          : "$hour : $minute",
                                                                      style:
                                                            ...
                                                            Row(
                                                              children: [
                                                                ...
                                                                Builder(builder:
                                                                  ...
                                                                  return Text(
                                                                    Provider.of<SearchPro>(context).searches[index].checkout ==
                                                                            null
                                                                        ? "Not Checked Out"
                                                                        : "$hour : $minute",
                                                                    style:
